...
@app.callback(Output("info", "children"), [Input("mpg-scatter", "hoverData")])
def callback_stats(hoverData):
    if hoverData is None:
        return ""
    v_index = hoverData["points"]
    stats = """
        {} cylinders
        {}cc displacement
        0 to 60mph in {} seconds
    """.format(df.iloc[v_index]["cylinders"], df.iloc[v_index]["displacement"],
